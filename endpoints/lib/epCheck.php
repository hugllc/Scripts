<?php
/**
 * This actually carries out the check functions
 *
 * PHP Version 5
 *
 * <pre>
 ...
 * @link       https://dev.hugllc.com/index.php/Project:Scripts
 */
class EpCheck extends EpScheduler
{
    /** @var string The plugin directory */
    protected $pluginDir = "checkPluginDir";
    ...
    */
    function __construct($config = array())
    {
        ...
        $where = "program LIKE 'check.php%' AND errorLastSeen < ?";
