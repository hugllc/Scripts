...
require_once HUGNET_INCLUDE_PATH.'/tables/DevicesHistoryTable.php';
...
$hist->selectOneInto("id = ?", array(hexdec($DeviceID)));
$dev = &$hist->toDeviceContainer();
print "Found ".date("Y-m-d H:i:s", $hist->SaveDate)."\n";
